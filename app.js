...
const checkGameOver = () => {
    ...
    if (gameboardPositions[0] === tileSymbol) {
        if (gameboardPositions[1] === tileSymbol && gameboardPositions[2] === tileSymbol) {
            return tileSymbol;
        }
        if (gameboardPositions[3] === tileSymbol && gameboardPositions[6] === tileSymbol) {
            return tileSymbol;
        }
        if (gameboardPositions[4] === tileSymbol && gameboardPositions[8] === tileSymbol) {
            return tileSymbol;
        }
    }
    
    if (gameboardPositions[1] === tileSymbol) {
        if (gameboardPositions[4] === tileSymbol && gameboardPositions[7] === tileSymbol) {
            return tileSymbol;
        }
    }

    if (gameboardPositions[2] === tileSymbol) {
        if (gameboardPositions[4] === tileSymbol && gameboardPositions[6] === tileSymbol) {
            return tileSymbol;
        }
        if (gameboardPositions[5] === tileSymbol && gameboardPositions[8] === tileSymbol) {
            return tileSymbol;
        }
    }   
    
    if (gameboardPositions[3] === tileSymbol) {
        if (gameboardPositions[4] === tileSymbol && gameboardPositions[5] === tileSymbol) {
            return tileSymbol;
        }
    } 

    if (gameboardPositions[6] === tileSymbol) {
        if (gameboardPositions[7] === tileSymbol && gameboardPositions[8] === tileSymbol) {
            return tileSymbol;
        }
    } 
